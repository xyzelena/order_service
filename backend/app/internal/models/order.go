...
// OrderFull представляет полную информацию о заказе со всеми связанными данными
...
// KafkaOrderMessage представляет сообщение из Kafka в том формате, как оно приходит
